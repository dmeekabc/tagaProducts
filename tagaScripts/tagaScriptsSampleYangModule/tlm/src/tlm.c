...
static obj_template_t *tlm_enable_obj;
static obj_template_t *tlm_disable_obj;
    ...
    val_value_t *dstval)
{
    ...
    tlmServiceStatus = (const xmlChar *)"disabled";
    res = val_set_simval_obj(
        dstval,
        dstval->obj,
        tlmServiceStatus);
...
/********************************************************************
* FUNCTION y_tlm_tlm_enable_validate
* 
* RPC validation phase
* All YANG constraints have passed at this point.
* Add description-stmt checks in this function.
...
*     error status
********************************************************************/
static status_t y_tlm_tlm_enable_validate (
    ses_cb_t *scb,
    rpc_msg_t *msg,
    xml_node_t *methnode)
{
    ...
    if (LOGDEBUG) {
        log_debug("\nStart SIL validate rpc <tlm-enable> from module tlm");
    }
...
} /* y_tlm_tlm_enable_validate */


/********************************************************************
* FUNCTION y_tlm_tlm_enable_invoke
* 
* RPC invocation phase
* All constraints have passed at this point.
* Call device instrumentation code in this function.
...
*     error status
********************************************************************/
static status_t y_tlm_tlm_enable_invoke (
    ses_cb_t *scb,
    rpc_msg_t *msg,
    xml_node_t *methnode)
{
    ...
    if (LOGDEBUG) {
        log_debug("\nStart SIL invoke rpc <tlm-enable> from module tlm");
    }
...
} /* y_tlm_tlm_enable_invoke */


/********************************************************************
* FUNCTION y_tlm_tlm_disable_validate
* 
* RPC validation phase
* All YANG constraints have passed at this point.
* Add description-stmt checks in this function.
...
*     error status
********************************************************************/
static status_t y_tlm_tlm_disable_validate (
    ses_cb_t *scb,
    rpc_msg_t *msg,
    xml_node_t *methnode)
{
    ...
    if (LOGDEBUG) {
        log_debug("\nStart SIL validate rpc <tlm-disable> from module tlm");
    }
...
} /* y_tlm_tlm_disable_validate */


/********************************************************************
* FUNCTION y_tlm_tlm_disable_invoke
* 
* RPC invocation phase
* All constraints have passed at this point.
* Call device instrumentation code in this function.
...
*     error status
********************************************************************/
static status_t y_tlm_tlm_disable_invoke (
    ses_cb_t *scb,
    rpc_msg_t *msg,
    xml_node_t *methnode)
{
    ...
    if (LOGDEBUG) {
        log_debug("\nStart SIL invoke rpc <tlm-disable> from module tlm");
    }
    ...
    const xmlChar *revision)
{
    ...
    tlm_enable_obj = ncx_find_object(
        tlm_mod,
        y_tlm_N_tlm_enable);
    if (tlm_enable_obj == NULL) {
        return ERR_NCX_DEF_NOT_FOUND;
    }

    tlm_disable_obj = ncx_find_object(
        tlm_mod,
        y_tlm_N_tlm_disable);
    if (tlm_disable_obj == NULL) {
        return ERR_NCX_DEF_NOT_FOUND;
    }
