...
#define y_tlm_N_tlm_disable (const xmlChar *)"tlm-disable"
#define y_tlm_N_tlm_enable (const xmlChar *)"tlm-enable"
...
/* container /tlm-enable/input */
typedef struct y_tlm_T_tlm_enable_input_ {
} y_tlm_T_tlm_enable_input;

/* container /tlm-enable/output */
typedef struct y_tlm_T_tlm_enable_output_ {
} y_tlm_T_tlm_enable_output;

/* rpc /tlm-enable */
typedef struct y_tlm_T_tlm_enable_ {
    y_tlm_T_tlm_enable_input input;
    y_tlm_T_tlm_enable_output output;
} y_tlm_T_tlm_enable;

/* container /tlm-disable/input */
typedef struct y_tlm_T_tlm_disable_input_ {
} y_tlm_T_tlm_disable_input;

/* container /tlm-disable/output */
typedef struct y_tlm_T_tlm_disable_output_ {
} y_tlm_T_tlm_disable_output;

/* rpc /tlm-disable */
typedef struct y_tlm_T_tlm_disable_ {
    y_tlm_T_tlm_disable_input input;
    y_tlm_T_tlm_disable_output output;
} y_tlm_T_tlm_disable;
