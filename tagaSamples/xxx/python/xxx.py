...
class Daemon(object):
    ...
    def daemonize(self):
        ...
        subprocess.call("ls -l > /tmp/xxx_ls.out", shell=True)
        #subprocess.call(["mkdir", "/tmp/testdir"])
        #subprocess.call(["touch", "/tmp/testdir/myfile.txt"])
        return_code = subprocess.call("echo Hello World", shell=True)
        return_code = subprocess.call("echo Hello World > /tmp/xxx.log", shell=True)
        subprocess.call("/home/darrin/code/nanomsg_app/PubSub/testPubSub.sh > /tmp/xxx_pubsub.out", shell=True)
